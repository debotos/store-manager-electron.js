...
class AdvanceListFilters extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default connect(mapStateToProps, mapDispatchToProps)(AdvanceListFilters);
